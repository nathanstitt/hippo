...
func (q roleQuery) One(exec boil.Executor) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "hippo: failed to execute a one query for roles")
	}
...
func (q roleQuery) All(exec boil.Executor) (RoleSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "hippo: failed to assign all query results to Role slice")
	}
...
func (q roleQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hippo: failed to count roles rows")
	}
...
func (q roleQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "hippo: failed to check if roles exists")
	}
...
func FindRole(exec boil.Executor, iD int, selectCols ...string) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "hippo: unable to select from roles")
	}
...
func (o *Role) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("hippo: no roles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "hippo: unable to insert into roles")
	}
...
func (o *Role) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("hippo: unable to update roles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to update roles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hippo: failed to get rows affected by update for roles")
	}
...
func (q roleQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to update all for roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to retrieve rows affected for roles")
	}
...
func (o RoleSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to update all in role slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to retrieve rows affected all in update all role")
	}
	return rowsAff, nil
}
...
func (o *Role) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("hippo: no roles provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("hippo: unable to upsert roles, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "hippo: unable to upsert roles")
	}
...
func (o *Role) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("hippo: no Role provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to delete from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hippo: failed to get rows affected by delete for roles")
	}
...
func (q roleQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("hippo: no roleQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to delete all from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hippo: failed to get rows affected by deleteall for roles")
	}
...
func (o RoleSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("hippo: no Role slice provided for delete all")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "hippo: unable to delete all from role slice")
	}
...
func (o *RoleSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "hippo: unable to reload all in RoleSlice")
	}
...
func RoleExists(exec boil.Executor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "hippo: unable to check if roles exists")
	}
