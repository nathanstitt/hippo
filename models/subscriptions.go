...
func (q subscriptionQuery) One(exec boil.Executor) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "hm: failed to execute a one query for subscriptions")
	}
...
func (q subscriptionQuery) All(exec boil.Executor) (SubscriptionSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "hm: failed to assign all query results to Subscription slice")
	}
...
func (q subscriptionQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to count subscriptions rows")
	}
...
func (q subscriptionQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "hm: failed to check if subscriptions exists")
	}
...
func FindSubscription(exec boil.Executor, iD int, selectCols ...string) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "hm: unable to select from subscriptions")
	}
...
func (o *Subscription) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("hm: no subscriptions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "hm: unable to insert into subscriptions")
	}
...
func (o *Subscription) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("hm: unable to update subscriptions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to update subscriptions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to get rows affected by update for subscriptions")
	}
...
func (q subscriptionQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to update all for subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to retrieve rows affected for subscriptions")
	}
...
func (o SubscriptionSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to update all in subscription slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to retrieve rows affected all in update all subscription")
	}
	return rowsAff, nil
}
...
func (o *Subscription) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("hm: no subscriptions provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("hm: unable to upsert subscriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "hm: unable to upsert subscriptions")
	}
...
func (o *Subscription) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("hm: no Subscription provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to delete from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to get rows affected by delete for subscriptions")
	}
...
func (q subscriptionQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("hm: no subscriptionQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to delete all from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to get rows affected by deleteall for subscriptions")
	}
...
func (o SubscriptionSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("hm: no Subscription slice provided for delete all")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to delete all from subscription slice")
	}
...
func (o *SubscriptionSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "hm: unable to reload all in SubscriptionSlice")
	}
...
func SubscriptionExists(exec boil.Executor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "hm: unable to check if subscriptions exists")
	}
