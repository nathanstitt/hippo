...
func (q tenantQuery) One(exec boil.Executor) (*Tenant, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "hm: failed to execute a one query for tenants")
	}
...
func (q tenantQuery) All(exec boil.Executor) (TenantSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "hm: failed to assign all query results to Tenant slice")
	}
...
func (q tenantQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to count tenants rows")
	}
...
func (q tenantQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "hm: failed to check if tenants exists")
	}
...
func FindTenant(exec boil.Executor, iD string, selectCols ...string) (*Tenant, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "hm: unable to select from tenants")
	}
...
func (o *Tenant) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("hm: no tenants provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "hm: unable to insert into tenants")
	}
...
func (o *Tenant) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("hm: unable to update tenants, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to update tenants row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to get rows affected by update for tenants")
	}
...
func (q tenantQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to update all for tenants")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to retrieve rows affected for tenants")
	}
...
func (o TenantSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to update all in tenant slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to retrieve rows affected all in update all tenant")
	}
	return rowsAff, nil
}
...
func (o *Tenant) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("hm: no tenants provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("hm: unable to upsert tenants, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "hm: unable to upsert tenants")
	}
...
func (o *Tenant) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("hm: no Tenant provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to delete from tenants")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to get rows affected by delete for tenants")
	}
...
func (q tenantQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("hm: no tenantQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to delete all from tenants")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "hm: failed to get rows affected by deleteall for tenants")
	}
...
func (o TenantSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("hm: no Tenant slice provided for delete all")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "hm: unable to delete all from tenant slice")
	}
...
func (o *TenantSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "hm: unable to reload all in TenantSlice")
	}
...
func TenantExists(exec boil.Executor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "hm: unable to check if tenants exists")
	}
